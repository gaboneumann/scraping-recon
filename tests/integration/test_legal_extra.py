"""
tests/integration/test_legal_extra.py
Additional integration tests for modules/legal.py.
Covers: ToS footer fallback, risk=MEDIUM when robots disallows path,
sitemap index type, tos risk levels (HIGH/MEDIUM/LOW), sitemap with lastmod.
"""
import httpx
import pytest
